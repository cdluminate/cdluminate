...
与标准硬拉的区别是起始位置不是地面，而是悬垂位。这样训练更加侧重后腿和臀部，而不是像标准硬拉一样训练整个后链。
...
注意区分宽握距硬拉 Snatch Grip Deadlift.
...
挺举分腿挺找间距：前脚90度，后脚大腿垂直地面，膝盖贴紧地面，站起则是分腿间距。分腿之后脚掌稍微内八 (pidgeon toe) 。

挺举支撑锁定问题：想象punch the ceiling.（1）手掌手腕活动度拉伸（2）斜方肌控制。锁定点辅助训练：壶铃摇摆，最高点锁定。实力推或者借力推，最高点锁定。
