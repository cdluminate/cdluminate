...
\begin{table}
\caption{认知功能的3*永恒之子(Child)表现： 治愈、游戏与任性。这是人格结构中的“游乐场”。当压力过大时，我们会退行到这个位置寻求安慰。表现形式：天真、单纯、创造力，或者是像被宠坏的孩子一样无理取闹。}
    \resizebox{\textwidth}{!}{
\begin{tabular}{ccccc}
\toprule
...
\midrule
Ti Child 孩童逻辑 & INFJ, ISFJ & 居然是这样！ & 纯粹的好奇宝宝，钻研冷门知识，享受解谜乐趣 & 逻辑钻牛角尖，为了这种“绝对正确”而固执己见\tabularnewline
Fi Child 孩童情感 & INTJ, ISTJ & 我偏要喜欢 & 傲娇(Tsundere)，深藏不露的深情，对特定人/物的死忠 & 情感任性，无视大局只顾个人喜好，因为敏感而甚至记仇\tabularnewline
Te Child 孩童执行 & ENFP, ESFP & 我能搞定！ & 虚张声势的指挥家，突然热衷于列计划和整理 & 甚至有些盲目的自信，为了证明能力而拒绝援助，三分钟热度\tabularnewline
Fe Child 孩童社交 & ENTP, ESTP & 大家都爱我 & 迷人的捣蛋鬼，天生的幽默感，为了活跃气氛不惜恶作剧 & 极度渴望掌声和关注，像孩子一样害怕被抛弃或被无视\tabularnewline
\midrule
\multicolumn{5}{c}{感知游戏组：Perception}\tabularnewline
\midrule
Ni Child 孩童远见 & ISTP, ISFP & 我有预感... & 相信命运与直觉，喜欢神秘学/阴谋论，甚至有些神叨 & 宿命论者，盲目相信自己的猜测，对未来产生无端的幻想\tabularnewline
Si Child 孩童经验 & INTP, INFP & 还是旧的好 & 恋旧与收藏癖，沉迷于熟悉的舒适区，喜欢重复的安稳 & 极度抗拒改变，遇到压力就想缩回被窝/童年，逃避现实\tabularnewline
Ne Child 孩童探索 & ESTJ, ESFJ & 如果这样呢？ & 突然的脑洞大开，讲冷笑话，甚至有些无厘头的创意 & 容易分心，盲目乐观，制定一堆根本无法落地的天马行空计划\tabularnewline
Se Child 孩童体验 & ENTJ, ENFJ & 我全都要！ & 报复性享乐，追求奢华/美食/高品质，极致的感官盛宴 & 缺乏节制，通过挥霍、暴饮暴食来解压，炫耀欲\tabularnewline
\bottomrule
\end{tabular}}
\end{table}
...
\begin{table}
\caption{认知功能的4*阿尼玛(Inferior)表现： 渴望与劫持(The Grip)。这是人格的“阿喀琉斯之踵”。它是通往潜意识的桥梁，也是压力爆发时的毁灭开关。表现形式：平时极度崇拜拥有此功能的人，压力下则会变成拙劣的模仿者或暴君。}
    \resizebox{\textwidth}{!}{
\begin{tabular}{ccccc}
\toprule
劣势功能 & 涉及类型 & 核心渴望 (Aspiration) & 抓取状态 (The Grip) & 典型心态\tabularnewline
\midrule
\multicolumn{5}{c}{感知型阿尼玛：Perception}\tabularnewline
\midrule
Se Inferior & INTJ, INFJ & 渴望像风一样自由 & \textbf{感官放纵}：暴饮暴食、过度购物、沉迷声色、强迫性整理细节 & “既然计划全毁了，那就让世界毁灭吧，我要喝个烂醉。”\tabularnewline
Si Inferior & ENTP, ENFP & 渴望安稳与归属 & \textbf{疑病与退缩}：对身体感觉过度敏感(疑病症)、强迫性守旧、陷入抑郁 & “我哪里都去不了，我病了，过去的一切都在惩罚我。”\tabularnewline
Ne Inferior & ISTJ, ISFJ & 渴望智慧与变通 & \textbf{灾难化想象}：看到一万种毁灭的可能性，甚至精神错乱的联想 & “一切都会完蛋的，不管我怎么做，结局注定是悲剧。”\tabularnewline
Ni Inferior & ESTP, ESFP & 渴望深刻与意义 & \textbf{偏执狂}：对未来的消极宿命论，毫无根据的猜忌，认为有阴谋 & “我知道他们在针对我，宇宙在暗示我接下来会发生可怕的事。”\tabularnewline
\midrule
\multicolumn{5}{c}{判断型阿尼玛：Judgement}\tabularnewline
\midrule
Te Inferior & INFP, ISFP & 渴望成就与秩序 & \textbf{暴君逻辑}：变得冷酷、独断专行、强迫别人执行错误的逻辑，对他人的无能暴怒 & “你们既然都没用，那就必须听我的，谁也不许反驳！”\tabularnewline
Ti Inferior & ENFJ, ESFJ & 渴望真理与独立 & \textbf{自我批判}：极度愤世嫉俗，用扭曲的逻辑攻击自己和他人，不仅不信人且充满鄙视 & “这毫无意义，你们都是虚伪的，所有的道理都是谎言。”\tabularnewline
Fe Inferior & INTP, ISTP & 渴望被人接纳 & \textbf{情感爆发}：像孩子一样哭闹，或是极度敏感于他人的评价，觉得自己被世界抛弃 & “没人爱我，我是多余的，我的存在就是个错误。”\tabularnewline
Fi Inferior & ENTJ, ESTJ & 渴望真实与平和 & \textbf{自怜自艾}：陷入深刻的孤独和受害者心态，情感脆弱得像易碎品，认为没人懂自己 & “我付出了一切，却得不到一点感激，我是世界上最孤独的人。”\tabularnewline
\bottomrule
\end{tabular}}
\end{table}
...
\caption{认知功能的恶魔(Demon)表现： 彻底崩溃时的毁灭打击。这是人格结构中最深层，最黑暗，也是最原始的部分。触发条件：自尊彻底崩溃，核心界限被严重侵犯，或者感受到极度绝望。表现形式：毁灭一切，不在乎输赢，只想让一切归零
...
\caption{认知功能的恶魔(Demon)整合：涅槃重生后的救赎之力(The Daemonic)。当恶魔功能被意识整合，它不再是毁灭者，而变成了通往完整人格的守门人。这种力量通常带有一种“非个人”的、超越小我的神性或宿命感。表现形式：大智若愚、绝地反击、或是对他人的深刻救赎。}
