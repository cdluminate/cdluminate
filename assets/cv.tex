...
%        During this summer, I studied object detection with object
%        relation modeled, while rethinking of the relationship between
%        context and bias.
%        The resulting manuscript is still under review for a double-blind conference.
...
%        \newline
%        \underline{Description:}
%        During this period, I studied adversarial attack and defense
%        in deep metric learning. One of the resulting manuscripts are published
%        to ICCV'2021. The other is still under review for T-PAMI.
\end{itemize}
