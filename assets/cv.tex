...
\item Reviewer for International Conferences
	\begin{itemize}[noitemsep, leftmargin=*]
		...
		\item[$\circ$] Asian Conf. on Computer vision (ACCV)\hfill 2018 -- 2022
	\end{itemize}
...
\item Organizer for International Workshops
    \begin{itemize}[noitemsep, leftmargin=*]
        ...
        \item[$\circ$] \href{https://cvpr24-advml.github.io}{$4$th Workshop of Adversarial Machine Learning on Computer Vision} \hfill CVPR 2024
    \end{itemize}
