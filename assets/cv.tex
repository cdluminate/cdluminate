...
\begin{itemize}[leftmargin=*]
    \item \includegraphics[height=1.2\fontcharht\font`\B]{amazon.png}
        ...
        \textcolor{gray}{\footnotesize\it Worked-on: Video Understanding, VLM Evaluation Metric}
    \item \includegraphics[height=1.2\fontcharht\font`\B]{g.png}
        ...
        \textcolor{gray}{\footnotesize\it Worked-on: Image Restoration~\ref{pub:unires}, Face Restoration~\ref{pub:refface}, and Infinite Zoom}\\
        \textcolor{gray}{\footnotesize\it Mentor: Hossein Talebi, Keren Ye, Mauricio Delbracio, Peyman Milanfar}
    \item \includegraphics[height=1.2\fontcharht\font`\B]{msft.png}
        ...
        \textcolor{gray}{\footnotesize\it Worked-on: Image Generation + LLM}\\
        \textcolor{gray}{\footnotesize\it Mentor: Kazuhito Koishida, Saeed Amizadeh}
    \item \includegraphics[height=1.2\fontcharht\font`\B]{wormpex.pdf}
        ...
        \textcolor{gray}{\footnotesize\it Mentor: Haoxiang Li, Yiding Yang, Gang Hua} \\
        \textcolor{gray}{\footnotesize\it Worked-on: Re-biasable Object Detection~\ref{pub:rebiasdet}}
    \item \includegraphics[height=1.2\fontcharht\font`\B]{xjtu.jpeg}
        ...
        Research Intern (Computer Vision) \hfill 05/2022 - 08/2022\\
        \textcolor{gray}{\footnotesize\it Worked-on: Adversarial Order Attack~\ref{pub:advorder}, Adversarial Ranking Defense~\ref{pub:robrank}}\\
        \textcolor{gray}{\footnotesize\it Supervisor: Le Wang, Sanping Zhou}
\end{itemize}
