...
\AddEnumerateCounter{\twodigits}{\twodigits}{00}
\makeatother
...
10450 NE 10th St          & Tel: (+1) *********** \\
Bellevue, WA 98004        & Email: {\small\email{cdluminate@gmail.com}}\\
United States             & Website: {\small\href{https://cdluminate.github.io/}{\tt cdluminate.github.io}}
\end{tabular}

\section{\sc Interests}
\begin{itemize}[noitemsep, leftmargin=*]
    \item Deep Learning, Computer Vision, and Multimodal Models
...
\begin{itemize}[leftmargin=*]
    \item \includegraphics[height=1.2\fontcharht\font`\B]{amazon.png}
        Amazon.com Services LLC, Ring AI\hfill Bellevue, WA 98004\\
        Applied Scientist (Vision Language Model)\hfill 01/2026 - Current\\
        \textcolor{gray}{\footnotesize\it \qquad Worked-on: Video Understanding, VLM Evaluation Metric}
    \item \includegraphics[height=1.2\fontcharht\font`\B]{g.png}
        Google Research, Computational Imaging Team\hfill Mountain View, CA 94043\\
        Student Researcher (Computer Vision) \hfill 05/2024 - 10/2025\\
        \textcolor{gray}{\footnotesize\it \qquad Worked-on: Image Restoration~\ref{pub:unires}, Face Restoration~\ref{pub:refface}, and Infinite Zoom}\\
        \textcolor{gray}{\footnotesize\it \qquad Mentor: Hossein Talebi, Keren Ye, Mauricio Delbracio, Peyman Milanfar}
    \item \includegraphics[height=1.2\fontcharht\font`\B]{msft.png}
        Microsoft Research, Applied Sciences Group\hfill Redmond, WA 98052\\
        Research Intern (Deep Learning)\hfill 05/2023 - 08/2023\\
        \textcolor{gray}{\footnotesize\it \qquad Worked-on: Image Generation + LLM}\\
        \textcolor{gray}{\footnotesize\it \qquad Mentor: Kazuhito Koishida, Saeed Amizadeh}
    \item \includegraphics[height=1.2\fontcharht\font`\B]{wormpex.pdf}
        Wormpex AI Research LLC \hfill Bellevue, WA 98004\\
        Research Intern (Computer Vision) \hfill 05/2022 - 08/2022\\
        \textcolor{gray}{\footnotesize\it \qquad Mentor: Haoxiang Li, Yiding Yang, Gang Hua} \\
        \textcolor{gray}{\footnotesize\it \qquad Worked-on: Re-biasable Object Detection~\ref{pub:rebiasdet}}
    \item \includegraphics[height=1.2\fontcharht\font`\B]{xjtu.jpeg}
        Xi'an Jiaotong University \hfill Xi'an, Shaanxi 710049\\
        Institute of Artificial Intelligence and Robotics (IAIR) \\
        Research Assistant (Computer Vision) \hfill 07/2020 - 06/2021\\
        \textcolor{gray}{\footnotesize\it \qquad Worked-on: Adversarial Order Attack~\ref{pub:advorder}, Adversarial Ranking Defense~\ref{pub:robrank}}\\
        \textcolor{gray}{\footnotesize\it \qquad Supervisor: Le Wang, Sanping Zhou}
\end{itemize}

\section{\sc Education}

\begin{itemize}[leftmargin=*]
\item \includegraphics[height=1.2\fontcharht\font`\B]{jhu.png}
    Johns Hopkins University \hfill Baltimore, MD, USA 21218\\
    Dept. Electrical and Computer Engineering, Whiting School of Engineering\\
    \textit{Ph.D.} Electrical and Electronics Engineering \hfill 08/2021 - 12/2025\\
    \textcolor{gray}{\small\it Advisor: Vishal M. Patel}
\item \includegraphics[height=1.2\fontcharht\font`\B]{xdu.jpg}
    Xidian University \hfill Xi'an, Shaanxi, China 710071\\
...
\item \includegraphics[height=1.2\fontcharht\font`\B]{xdu.jpg}
    Xidian University \hfill Xi'an, Shaanxi, China 710126\\
...
\section{\sc Publications}
    ...
    \hspace*{9.7em}(Jul. 07 2026)\quad Citations: 2026\quad H-Index: 11\quad i10-Index: 11\\
    Other Identifiers:
    {\footnotesize\tt
...
{\sc Journal Articles:} \hfill(2 TPAMI, 2 TMLR, 1 TMM)\\

\begin{enumerate}[noitemsep, leftmargin=*, label={[J\twodigits*]}, ref={[J\twodigits*]}]

\item \label{pub:refface}\underline{Mo Zhou}, Keren Ye, Viraj Shah, Kangfu Mei, Mauricio Delbracio,
\reversemarginpar\marginpar{\hspace{-9.5em}
\href{https://openreview.net/forum?id=g9YzUDnUUS}{[OpenReview]}
\href{https://arxiv.org/abs/2505.21905}{[arXiv]}
}
Peyman Milanfar, Vishal M. Patel, Hossein Talebi,
\textit{``Reference-Guided Identity Preserving Face Restoration,''}
Transactions on Machine Learning Research (TMLR), 2026.

\item \label{pub:rebiasdet}\underline{Mo Zhou}, Yiding Yang, Haoxiang Li, Vishal M. Patel, Gang Hua,
\reversemarginpar\marginpar{\hspace{-9.5em}
\href{https://ieeexplore.ieee.org/document/11410103}{[PDF]}
\href{https://arxiv.org/abs/2402.17207}{[arXiv]}
}
\textit{``Deployment Prior Injection for Run-time Re-biasable Object Detection,''}
IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI), 2026.
\texttt{\small DOI: 10.1109/TPAMI.2026.3667914}

\item Yatong Bai, \underline{Mo Zhou}, Vishal M. Patel, Somayeh Sojoudi,
\reversemarginpar\marginpar{\hspace{-9.5em}
\href{https://openreview.net/forum?id=pyD6cujUmL}{[OpenReview]}
...
\item \label{pub:robrank}\underline{Mo Zhou},
\reversemarginpar\marginpar{\hspace{-9.5em}
...
\begin{enumerate}[noitemsep, leftmargin=*, label={[C\twodigits*]}, ref={[C\twodigits*]}]

\item Mucong Ding, Bang An, Tahseen Rabbani, Chenghao Deng, Anirudh Satheesh,
\reversemarginpar\marginpar{\hspace{-9.5em}
\href{https://proceedings.neurips.cc/paper_files/paper/2025/hash/15389039ccef67b6bed9b2df8414400f-Abstract-Datasets_and_Benchmarks_Track.html}{[PDF]}
}
...
\item \label{pub:unires}\underline{Mo Zhou}, Keren Ye, Mauricio Delbracio, Peyman Milanfar,
\reversemarginpar\marginpar{\hspace{-9.5em}
\href{https://openaccess.thecvf.com/content/ICCV2025/html/Zhou_UniRes_Universal_Image_Restoration_for_Complex_Degradations_ICCV_2025_paper.html}{[PDF]}
\href{https://arxiv.org/abs/2506.05599}{[arXiv]}
}
Vishal M. Patel, Hossein Talebi,
...
\item \label{pub:advtrace}\underline{Mo Zhou}, Vishal M. Patel,
\reversemarginpar\marginpar{\hspace{-9.5em}
...
\item \label{pub:robdml}\underline{Mo Zhou}, Vishal M. Patel,
\reversemarginpar\marginpar{\hspace{-9.5em}
...
\item \label{pub:advorder}\underline{Mo Zhou},
\reversemarginpar\marginpar{\hspace{-9.5em}
...
\item \label{pub:advrank}\underline{Mo Zhou},
\reversemarginpar\marginpar{\hspace{-9.5em}
...
\item \label{pub:ladder}\underline{Mo Zhou},
\reversemarginpar\marginpar{\hspace{-9.5em}
...
\begin{enumerate}[noitemsep, leftmargin=*, label={[X\twodigits*]}]
...
\begin{enumerate}[noitemsep, leftmargin=*, label={[P\twodigits*]}]
...
%            \hfill 2022
        \item[$\circ$] Google Summer of Code (GSoC) as Mentor w/ Debian Project \hfill 2025\\
        ...
        \item[$\circ$] Open Source Promotion Plan (OSPP) w/ Tsinghua University TUNA Association \hfill 2020\\
        ...
        \item[$\circ$] Google Summer of Code (GSoC) as Student w/ Debian Project \hfill 2020\\
        ...
        \item[$\circ$] Google Summer of Code (GSoC) as Student w/ Gentoo Foundation \hfill 2019\\
...
\begin{itemize}[leftmargin=*]
    ...
    \item Xidian University Secondary School Scholarship.%
        \href{https://web.archive.org/web/20181110035026/https://see.xidian.edu.cn/html/news/9732.html}{$^+$} \hfill 2017-2018
...
\section{\sc Affiliation}

\begin{itemize}[leftmargin=*]
    \item \includegraphics[height=1.2\fontcharht\font`\B]{ieee.png}
        Student Member, IEEE\hfill Aug 2021 -- Dec 2025
\end{itemize}
