...
\begin{itemize}[noitemsep, leftmargin=*]
	\item Deep Learning and Computer Vision
    \item Image Restoration and Enhancement
    \item Vision-Language Models and Large Language Models
...
\section{\sc Publications}
	...
	\hspace*{9.7em}(Feb. 02 2025)\quad Citations: 1504\quad H-Index: 10\quad i10-Index: 10\\
	Other Identifiers:
	{\footnotesize\tt
...
\end{enumerate}
	...
	(3 CVPR, 2 ICCV, 1 ECCV, 1 NeurIPS, 1 ICLR, 1 AAAI)\\
...
\textit{``A Simple Diffusion Transformer on Unified Video, 3D, and Game Field Generation,''}
...
%2025, Under Review.
%
%\item \underline{Mo Zhou}, Keren Ye, Mauricio Delbracio, Kangfu Mei, Viraj Shah, Peyman Milanfar, Vishal M. Patel, Hossien Talebi,
...
\begin{itemize}[leftmargin=*]
    ...
    \item Google Summer of Code (GSoC) as Mentor with Debian Project \hfill 2025\\
          Project: \textit{Packaging LLM Inference Libraries} (Student: Kohei Sendai)
