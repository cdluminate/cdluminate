...
\section{\sc Publications}
	...
	\hspace*{9.7em}(Nov. 22 2023)\qquad Citations: 1091\qquad H-Index: 8\qquad i10-Index: 7\\
	Other Identifiers:
	{\footnotesize\tt
...
\item Reviewer for International Conferences
	\begin{itemize}[noitemsep, leftmargin=*]
		...
		\item[$\circ$] International Conf. Learning Representations (ICLR)\hfill 2022, 2023, 2024
...
\item Reviewer for International Journals
	\begin{itemize}[noitemsep, leftmargin=*]
		\item[$\circ$] IEEE Trans. on Pattern Analysis and Machine Intelligence (TPAMI)\hfill 2021, 2022, 2023
        ...
        \item[$\circ$] Elsevier Journal of Image and Vision Computing (IMAVIS)\hfill 2023
        %
		...
		\item[$\circ$] Springer Journal of Machine Vision and Application (MVA)\hfill 2020, 2021, 2022,%
			...
			\vspace{-4pt}
		\item[$\circ$] Springer Journal of Complex \& Intelligent Systems (CAIS)\hfill 2021, 2022, 2023
        %
        \item[$\circ$] Oxford University Press: The Computer Journal (COMPJ)\hfill 2023
	\end{itemize}
\item Organizer for International Workshops
    \begin{itemize}[noitemsep, leftmargin=*]
        \item[$\circ$] \href{https://iccv23-arow.github.io/}{$4$th Workshop on Adversarial Robustness In the Real World}  \hfill ICCV  2023
